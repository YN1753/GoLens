...
for page in index.html gmp.html channel.html gc.html slice-map.html sync-context.html memory.html iface-defer.html select.html string.html error.html generics.html netpoller.html testing.html; do
