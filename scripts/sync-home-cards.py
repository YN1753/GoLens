...
blurb = {
    ...
    "json": ("tag、omitempty、自定义、流式。", "LAB · JSON"),
    ...
    "atomic": ("Add/CAS/指针发布；与 mutex 取舍。", "LAB · 原子操作"),
    ...
    "toolchain": ("build/run/test/vet/go work。", "LAB · 命令卡"),
    "embed": ("//go:embed 与 embed.FS。", "LAB · 打包资源"),
